...
const Link = ({ children }) => <a href="#" className="dsv-nav-link" style={{ display: "inline", padding: 0, color: "var(--color-text-link)" }}>{children}</a>;
  ...
  return (
    <div className="dsv-stack">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: "var(--space-4)" }}>
        {[["Revenue", "₺48.2k", "up", "▲ 12%"], ["Users", "1.284", "up", "▲ 4%"], ["Error rate", "0.4%", "down", "▼ 0.1%"]].map(([k, v, dir, d]) => (
  ...
  return (
    <div style={{ maxWidth: 520, margin: "0 auto" }}>
      <div className="dsv-breadcrumb" style={{ marginBottom: "var(--space-4)" }}>
        <a href="#">Workspace</a><Icon name="chevronRight" size={12} /><span aria-current="page">Projects</span>
      </div>
      <div className="dsv-card">
